...
export default function Button({
  ...
  return (
    <Link
      href={href}
      className={clsx(
        "inline-flex items-center gap-3 border-2 px-7 py-4 text-xs font-bold uppercase tracking-[0.14em] transition-all duration-200 hover:-translate-y-px rounded-2xl",
        variants[variant],
        className,
      )}
